...
module.exports = function(Usermanagement) {
    ...
    Usermanagement.findOne({where: where}, function(err, user) {
      if (err) {
        return cb(err);
      }
      if (!user) {
    ...
    //send password reset link when requested
  /*  Usermanagement.on('registerPasswordRequest', function(info) {
      console.log("Register password");

    });*/

    Usermanagement.registerPassword = function(options, cb) {
